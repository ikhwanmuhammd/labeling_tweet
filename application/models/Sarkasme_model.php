 ...
 * 
 */
class Sarkasme_model extends CI_Model
{
    ...
    private function _get_datatables_query($id)
    {
        ...
        $this->db->where('anotator' . $id . ' =', 'sarkasme');
    ...
    {
        return $this->db->get_where('tbl_tweet', array('label' => 'sarkasme'));
    }
    ...
    public function hasil_sarkasme($id)
    {
        $data = array(
            'anotator' => $id,
            'label' => 'sarkasme'
